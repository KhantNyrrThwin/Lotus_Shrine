    ...
    <div className="fixed bottom-0 left-0 w-full bg-gradient-to-r bg-amber-800 text-white shadow-2xl z-50 flex items-center justify-between px-6 py-3 transition-all">
      ...
      <div className="flex items-center space-x-4">
        <button
          ...
          className="p-2 rounded-full cursor-pointer hover:bg-black hover:bg-opacity-20 transition-colors"
        >
          <SkipBack size={20} />
        </button>
        <button
          onClick={togglePlayPause}
          className="p-3 rounded-full cursor-pointer bg-white text-[#4f3016] shadow hover:bg-gray-200 transition-colors"
        >
      ...
      <div className="flex items-center space-x-2 w-48">
        <button
          onClick={toggleMute}
          className="p-1 rounded-full cursor-pointer hover:bg-black hover:bg-opacity-20 transition-colors"
        >

...
function Grid_Features() {
  return (
    <>
    <div className= "flex bg-[url('./assets/bar1.jpg')] bg-cover h-[1000px] mt-0" >
      ...
      <div className="p-8 m-5 rounded-lg bg-gray-100 w-[300px] h-[200px] cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg">

        ...
        <div className="absolute top-0 left-0 right-0 h-[58px] flex items-center">
          ...
          <div className="flex text-[15px] 2xl:text-[17px]  2xl:w-[1100px]  font-bold space-x-[40px] ml-[191px]  2xl:ml-[161px]">
           ...
           <div className="ml-0" onMouseEnter={() => setKoeNaWinOpen(true)}   onMouseLeave={() => setKoeNaWinOpen(false)}>
            <p className={`text-white 2xl:ml-[80px] cursor-pointer ${isKoeNaWinOpen ? "text-green-400" : "text-green-400"}`}>ကိုးနဝင်း</p>
            <AnimatePresence>
              {isKoeNaWinOpen && (
                <motion.div
                initial={{ opacity: 0, y: 0 }}
            ...
            <div className="ml-0" onMouseEnter={() => setAboutOpen(true)}   onMouseLeave={() => setAboutOpen(false)}>
              <p className={"text-white 2xl:ml-[80px] cursor-pointer "}>ကျွန်ုပ်တို့အကြောင်း</p>
              <AnimatePresence>
                {isAboutOpen && (
                  <motion.div
                    initial={{ opacity: 0, y: 0 }}
           ...
           <div className="ml-0" onMouseEnter={() => setAccountOpen(true)}   onMouseLeave={() => setAccountOpen(false)}>
            <p className={`text-white 2xl:ml-[80px] cursor-pointer ${isAccountOpen ? "text-green-400" : "text-green-400"}`}>အကောင့်</p>
            <AnimatePresence>

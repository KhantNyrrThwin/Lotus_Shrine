          ...
          <div className="flex flex-col w-[430px] h-[280px] ml-[58px] mt-[5px] item-left ">
            <Link to="/">
              <div className="flex w-[300px] h-[100px]    items-center 2xl:ml-[80px]">
                ...
                <h1 className="text-white text-[24px] font-bold ml-[10px] mt-[10px] ">
                  Lotus Shrine
                </h1>
                <p className="text-white text-[16px] font-bold ml-[10px] mt-[10px]"></p>
              </div>
            </Link>
            <p className="text-white text-[14px] w-[330px] text-justify 2xl:ml-[80px]">
              ဤပရောဂျက်သည် တရားထိုင်ခြင်းနှင့် ဆုတောင်းခြင်း
              ကဲ့သို့သောဗုဒ္ဓဘာသာရဲ့ဝိညာဉ်ပိုင်းဆိုင်ရာအလေ့အထ များကိုနည်း
              ပညာနှင့်ပေါင်းစပ်၍၊ ခရီးသွား၍ မရသောသူ များအတွက်ပါ အွန်လိုင်းမှတစ်
              ဆင့် ခံစားနိုင်မည့် မြတ်နိုး အေးချမ်းသော ပလက်ဖောင်းတစ်ခု အဖြစ်
              ဖန်တီးထား ပါသည်။
            </p>
          </div>

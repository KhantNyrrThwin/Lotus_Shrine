    ...
    <div className="flex flex-col items-center h-screen bg-[#FDE9DA]">
        ...
        <div className="flex flex-rol w-full h-full mt-[17px] ">
            <div className="w-[251px] h-[508px] ml-[38px]  ">
                <button 
                  className={`w-[247px] h-[68px] rounded-[19px] text-white text-[18px] font-bold mt-[6px] mb-[18px] transition-colors duration-200 ${
                    selectedGrade === "first" 
                ...
                <button 
                  className={`w-[247px] h-[68px] rounded-[19px] text-white text-[18px] font-bold mb-[18px] transition-colors duration-200 ${
            ...
            <div className="w-[865px] ml-[84px] mr-[42px] flex flex-col  items-center">
                ...
                <button 
                  className={`w-[247px] h-[68px] rounded-[19px] text-white text-[18px] font-bold transition-colors duration-200 ${
